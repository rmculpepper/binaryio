...
@(begin
  ...
  (the-eval '(require binaryio binaryio/bitvector binaryio/bitport
                      binaryio/prefixcode racket/port)))
...
@; ----------------------------------------
@section[#:tag "prefixcode"]{Prefix Codes: Encoding and Decoding}

@defmodule[binaryio/prefixcode]
@history[#:added "1.2"]

@section-index["Huffman code"]
...
It does not implement algorithms for building such codes.
